    ...
    public class SceneBootstrap : MonoBehaviour
    {
        ...
        private void BuildUI()
        {
            ...
            TMP_Text scoreText = CreateText(canvasGo.transform, "Score: 0",
                new Vector2(1, 1), new Vector2(-30, -30), TextAlignmentOptions.Right, 36);
            TMP_Text livesText = CreateText(canvasGo.transform, "HP: 3/3",
                new Vector2(0, 1), new Vector2(30, -30), TextAlignmentOptions.Left, 36);
            TMP_Text waveText = CreateText(canvasGo.transform, "Wave 1",
                new Vector2(0.5f, 1), new Vector2(0, -30), TextAlignmentOptions.Center, 36);
